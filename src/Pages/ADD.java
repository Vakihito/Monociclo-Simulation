...
public class ADD extends Composite {
	 ...
	 * @param style
	 */
	public ADD(Composite parent, int style, Vector <Bloco> Instructions) {
		...
		bntControl.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
			}
		});
		bntControl.setFont(SWTResourceManager.getFont("Ubuntu", 15, SWT.BOLD));
		bntControl.setBounds(553, 629, 112, 34);
